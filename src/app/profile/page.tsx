        ...
        {vouchers.length > 0 && (
          <div className="bg-white rounded-lg shadow-md p-6 mb-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <Badge className="bg-purple-600">{vouchers.filter(v => !v.is_used).length} Active</Badge>
            </div>
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <div className="flex items-center gap-2">
                        <Badge className={voucher.is_used ? 'bg-gray-400' : 'bg-purple-600'}>
                          {voucher.value}
                        </Badge>
                        {voucher.is_used && (
                      ...
                      <p className="text-xs text-gray-600 mt-1">
                        Expires: {new Date(voucher.expired_at).toLocaleDateString('en-US', {
                          year: 'numeric',
                          month: 'short',
                          day: 'numeric'
                        })}
                    ...
                    <Gift className={`w-6 h-6 ${voucher.is_used ? 'text-gray-400' : 'text-purple-600'}`} />
                  </div>
              ...
              {[...Array(12)].map((_, index) => {
                ...
                return (
                  <div key={index} className="flex flex-col items-center gap-1">
                    <div
                      className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full border-4 flex items-center justify-center transition-all relative ${
                        isCompleted
                          ? isGoal
