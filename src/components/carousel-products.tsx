                        ...
                        <div className="md:flex  mb-12 md:justify-between items-center">
                            ...
                            <div className="text-left flex flex-col">
                                <div className="inline-block ">
                                    <h1 className="text-4xl sm:text-5xl mb-4 w-full text-[#6B50B0] text-eliane" >Ready To Use</h1>
                                    <div className="flex gap-5">
                                                <h1 className="text-4xl sm:text-5xl mb-4 w-full text-[#6B50B0] text-eliane" >And Adobtable</h1>
